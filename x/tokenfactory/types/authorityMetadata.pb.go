...
func init() {
	proto.RegisterType((*DenomAuthorityMetadata)(nil), "cosmwasm.token-factory.v1beta1.DenomAuthorityMetadata")
}

func init() {
	proto.RegisterFile("cosmwasm/tokenfactory/v1beta1/authorityMetadata.proto", fileDescriptor_99435de88ae175f7)
}
