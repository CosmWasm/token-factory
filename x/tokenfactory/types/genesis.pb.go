...
func init() {
	proto.RegisterType((*GenesisState)(nil), "cosmwasm.token-factory.v1beta1.GenesisState")
	proto.RegisterType((*GenesisDenom)(nil), "cosmwasm.token-factory.v1beta1.GenesisDenom")
}

func init() {
	proto.RegisterFile("cosmwasm/tokenfactory/v1beta1/genesis.proto", fileDescriptor_5749c3f71850298b)
}
